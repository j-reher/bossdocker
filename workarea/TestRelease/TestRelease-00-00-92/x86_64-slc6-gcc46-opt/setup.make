...
root_no_config (from PROJECT) excludes [root_config]
root_root (from PROJECT) excludes [root_no_root]
root_cleanup (from PROJECT) excludes [root_no_cleanup]
root_scripts (from PROJECT) excludes [root_no_scripts]
root_prototypes (from PROJECT) excludes [root_no_prototypes]
root_with_installarea (from PROJECT) excludes [root_without_installarea]
root_with_version_directory (from PROJECT) excludes [root_without_version_directory]
root (from PROJECT)
...
----------> CMTPATH
# Add path /root/workarea from initialization
