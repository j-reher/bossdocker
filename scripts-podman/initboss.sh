...
do
    case "$1" in
        ...
        -h | --help )
            ...
            echo "  -r <repository/> Container repository to use. Omit for podmans default repository (usually docker.io)."
...
printf 'Starting container and mounting %s as workarea\n' "$REPOSITORY" "$CONTAINER_VERSION" "$WORKAREA"
export WORKAREA
